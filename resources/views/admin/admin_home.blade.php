		  		...
		  		<div class="col-md-6">
		  			<div class="content-box-large">
		  				...
		  				<div class="panel-body">
							...
							Category:	<option><?php echo $value->name ?></option>
									@endforeach											
									</select><br>									
			  				Name	<input type="text" name="pro_name" class="form-control"><br/>
			  				Price	<input type="text" name="pro_price" class="form-control"><br/>
			  				Code	<input type="text" name="pro_code" class="form-control"><br/>
			  				
			  				Information	<input type="text" name="pro_info" class="form-control"><br/>
			  				Image	<input type="file" name="pro_image" class="form-control"><br/>
			  				Spl_Price	<input type="text" name="spl_price" class="form-control"><br/>		  			<div class="panel-options">
